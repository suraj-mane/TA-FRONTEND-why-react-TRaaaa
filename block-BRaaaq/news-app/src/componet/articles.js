...
function Articles() {
    return (
        <>
        <h1 className="text-center my-3">ALL Articles</h1>
...
function Card(props) {
    return (
        <div className="shadow p-3 mb-5 bg-body rounded text-center">
            <img className="w-100  c-img" src={props.urlToImage} />
            <h5 className="p-3 text-primary">{props.title.toUpperCase()}</h5>
            <h5 className="text-warning">{props.author.toUpperCase()}</h5>
